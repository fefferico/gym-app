...
export class ActionMenuComponent implements OnChanges, OnDestroy {
  ...
  @Input() dropdownMenuClass: string = 'origin-top-right absolute right-0 top-full mt-2 w-56 rounded-lg shadow-lg bg-gray-100 dark:bg-gray-800 ring-1 ring-black ring-opacity-5 p-1 z-[60] border border-gray-300 border-2 min-w-[250px] overflow-hidden';
