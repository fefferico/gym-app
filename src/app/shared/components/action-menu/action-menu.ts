...
export class ActionMenuComponent implements OnChanges, OnDestroy {
  ...
  @Input() dropdownMenuClass: string = 'origin-top-right absolute right-0 top-full mt-2 w-56 rounded-lg shadow-lg bg-gray-800 ring-1 ring-black ring-opacity-5 p-2 z-[60]';
  defaultDropdownButtonClass: string = 'flex items-center w-full rounded-md px-3 py-2 text-lg font-medium text-white';
