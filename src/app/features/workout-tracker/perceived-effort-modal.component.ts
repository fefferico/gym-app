  ...
  template: `
    <div class="fixed inset-0 bg-black bg-opacity-60 z-40 flex justify-center items-center" (click)="dismiss()">
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-6 md:p-8 max-w-md w-full mx-4" (click)="$event.stopPropagation()">
        <section>
<h2 class="text-2xl font-bold text-center text-gray-800 dark:text-gray-100 mb-2">Rate Your Perceived Feelings</h2>
        <p class="text-center text-gray-600 dark:text-gray-400 mb-4">How challenging was this workout session?</p>
        ...
        <section class="pt-4">
          <p class="text-center text-gray-600 dark:text-gray-400 mb-4">How do you feel after this workout session?</p>
