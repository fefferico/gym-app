...
export interface Routine {
  ...
  name: string;
  description?: string;
  workoutExercises: WorkoutExercise[]; // This list will be ordered, and superset exercises will be contiguous
  estimatedDuration?: number;
  lastPerformed?: string;
  goal?: 'hypertrophy' | 'strength' | 'muscularEndurance' | 'tabata' | 'cardiovascular Endurance' | 'fatLossBodyComposition' | 'mobilityFlexibility' | 'powerExplosiveness' | 'speedAgility' | 'balanceCoordination' | 'skillAcquisition' | 'rehabilitationInjuryPrevention' | 'mentalHealthStressRelief' | 'generalHealthLongevity' | 'sportSpecificPerformance' | 'maintenance' | 'rest' | 'custom';
