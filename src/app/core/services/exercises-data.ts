...
export const EXERCISES_DATA: Exercise[] = [
  ...
  },
  {
    ...
    description: 'A compound upper-body exercise that targets the chest-upper, shoulders, and triceps using a barbell on an incline bench.',
    category: 'barbells',
    muscleGroups: ["chest-upper", "shoulders", "triceps"],
  ...
  },
  {
    ...
    "category": "machines",
    "muscleGroups": ["chest", "anterior-deltoid", "triceps"],
    "primaryMuscleGroup": "chest",
  ...
  },
  {
    ...
    description: 'A compound upper-body exercise that targets the chest-upper, shoulders, and triceps using dumbbells on an incline bench, allowing for a greater range of motion.',
    category: "dumbbells",
    muscleGroups: ["chest-upper", "shoulders", "triceps"],
    primaryMuscleGroup: "chest",
  ...
  },
  {
    ...
    description: 'A compound overhead press exercise that builds shoulder strength and size. It is performed standing, engaging the core for stability, and pressing a barbell from the chest-upper to an overhead position with arms fully extended.',
    category: 'strength',
    muscleGroups: ["shoulders", 'shoulders', "triceps", 'chest-upper', "core"],
  ...
  },
  {
    ...
    "muscleGroups": ["lats", "biceps", "traps-middle","traps-lower", "rhomboids", "forearms", "core"],
  ...
  },
  {
    ...
    "muscleGroups": ["triceps", "chest-lower", "anterior-deltoid"],
  ...
  },
  {
    ...
    "category": "barbells",
    "primaryMuscleGroup": "lats",
    "muscleGroups": ["lats", "rhomboids", "traps-middle","traps-lower", "biceps", "forearms", "lower-back"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "full-body",
    "muscleGroups": ["glutes", "hamstrings", "quadriceps", "shoulders", "core", "lats", "upper-back"],
    "equipmentNeeded": ["kettlebell"],
    "imageUrls": [],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "lats",
    "muscleGroups": ["lats", "rhomboids", "traps-middle", "biceps", "forearms", "core"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "hamstrings",
    "muscleGroups": ["hamstrings", "glutes", "lower-back", "core", "traps", "forearms"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "shoulders",
    "muscleGroups": ["shoulders", "glutes", "hamstrings", "upper-back", "biceps", "core"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "category": "machines",
    "primaryMuscleGroup": "lats",
    "muscleGroups": ["lats", "biceps", "rhomboids", "traps-middle","traps-lower"],
  ...
  },
  {
    ...
    "category": "machines",
    "primaryMuscleGroup": "back",
    "muscleGroups": ["rhomboids", "lats", "traps-middle", "biceps", "posterior-deltoid"],
  ...
  },
  {
    ...
    "category": "machines",
    "primaryMuscleGroup": "posterior-deltoid",
    "muscleGroups": ["posterior-deltoid", "rhomboids", "traps-middle"],
  ...
  },
  {
    ...
    "category": "cables",
    "primaryMuscleGroup": "posterior-deltoid",
    "muscleGroups": ["posterior-deltoid", "rhomboids", "traps-middle","traps-lower", "rotator-cuff"],
    "equipmentNeeded": ["cable-machine", "rope-attachment-cables"],
  ...
  },
  {
    ...
    "category": "bodyweight-calisthenics",
    "primaryMuscleGroup": "triceps",
    "muscleGroups": ["triceps", "anterior-deltoid", "chest-lower"],
  ...
  },
  {
    ...
    "description": "Targets the chest-upper, shoulders, and triceps by pressing dumbbells on an incline bench.",
    "category": "dumbbells",
    "primaryMuscleGroup": "chest-upper",
    "muscleGroups": ["chest-upper", "anterior-deltoid", "triceps"],
    "equipmentNeeded": ["dumbbell", "incline-bench"],
  ...
  },
  {
    ...
    "muscleGroups": ["erector-spinae", "core", "back"],
    "equipmentNeeded": [],
  ...
  },
  {
    ...
    "category": "stretching",
    "primaryMuscleGroup": "lower-back",
    "muscleGroups": ["lower-back", "hip-flexors", "thigh", "ankle"],
    "equipmentNeeded": [],
  ...
  },
  {
    ...
    "muscleGroups": ["quadriceps", "hip-flexors", "calves", "core", "cardio"],
    "equipmentNeeded": [],
  ...
  },
  {
    ...
    "category": "bodyweight-calisthenics",
    "primaryMuscleGroup": "shoulders",
    "muscleGroups": ["shoulders", "triceps", "chest-upper", "core"],
    "equipmentNeeded": [],
  ...
  },
  {
    "id": "pike-push-up",
    "name": "Pike Push-up",
    "description": "Targets the shoulders and chest-upper with a push-up position that emphasizes overhead pressing motion.",
    "category": "bodyweight-calisthenics",
    "primaryMuscleGroup": "shoulders",
    "muscleGroups": ["shoulders", "triceps", "chest-upper"],
    "equipmentNeeded": [],
  ...
  },
  {
    ...
    "description": "An increased difficulty push-up variation that targets the chest-upper and shoulders by elevating the feet.",
    "category": "bodyweight-calisthenics",
    "primaryMuscleGroup": "chest",
    "muscleGroups": ["chest-upper", "anterior-deltoid", "triceps"],
    "equipmentNeeded": [],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "full-body",
    "muscleGroups": ["hip-flexors", "glutes", "back", "shoulders", "arms"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "full-body",
    "muscleGroups": ["hip-flexors", "back", "shoulders", "arms"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "finger-grip",
  ...
  },
  {
    ...
    category: "kettlebells",
    primaryMuscleGroup: "full-body",
    muscleGroups: ["hip-flexors", "glutes", "hamstrings", "back"],
    equipmentNeeded: ["kettlebell"],
  ...
  },
  {
    ...
    category: "kettlebells",
    primaryMuscleGroup: "full-body",
    muscleGroups: ["hip-flexors", "glutes", "back"],
    equipmentNeeded: ["kettlebell"],
  ...
  },
  {
    ...
    category: "kettlebells",
    primaryMuscleGroup: "full-body",
    muscleGroups: ["core", "forearms", "hip-flexors"],
    equipmentNeeded: ["kettlebell"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "hamstrings",
    "muscleGroups": ["hamstrings", "glutes", "core", "lower-back", "hips"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    category: "kettlebells",
    primaryMuscleGroup: "core",
    muscleGroups: ["obliques", "shoulders", "hip-flexors"],
    equipmentNeeded: ["kettlebell"],
  ...
  },
  {
    ...
    "description": "An isolation exercise for the chest-upper using dumbbells on an incline bench, focusing on the pectoral muscles.",
    "category": "dumbbells",
    "primaryMuscleGroup": "chest-upper",
    "muscleGroups": ["chest-upper", "anterior-deltoid"],
    "equipmentNeeded": ["dumbbell", "incline-bench"],
  ...
  },
  {
    ...
    "description": "A machine-based compound exercise that targets the chest-upper, shoulders, and triceps with a guided, inclined pressing motion.",
    "category": "machines",
    "primaryMuscleGroup": "chest-upper",
    "muscleGroups": ["chest-upper", "anterior-deltoid", "triceps"],
...

  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "shoulders",
    "muscleGroups": ["shoulders", "triceps", "lats", "obliques", "hip-flexors", "erector-spinae"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "core",
    "muscleGroups": ["obliques", "shoulders", "forearms", "upper-back"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "glutes",
    "muscleGroups": ["glutes", "hamstrings", "upper-back", "biceps", "core"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "shoulders",
    "muscleGroups": ["shoulders", "triceps", "lats", "obliques", "serratus-anterior"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "glutes",
    "muscleGroups": ["glutes", "hamstrings", "core", "upper-back"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "core",
    "muscleGroups": ["core", "hip-flexors", "glutes", "forearms"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "core",
    "muscleGroups": ["obliques", "quadriceps", "glutes", "upper-back"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "glutes",
    "muscleGroups": ["glutes", "hamstrings", "obliques", "adductors", "lower-back"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "hamstrings",
    "muscleGroups": ["hamstrings", "erector-spinae", "lower-back", "glutes"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "shoulders",
    "muscleGroups": ["shoulders", "triceps", "core", "erector-spinae", "hip-flexors"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "core",
    "muscleGroups": ["core", "shoulders", "upper-back"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "shoulders",
    "muscleGroups": ["shoulders", "erector-spinae", "chest"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "core",
    "muscleGroups": ["core", "quadriceps", "glutes", "anterior-deltoid"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "full-body",
    "muscleGroups": ["core", "quadriceps", "glutes", "hip-flexors", "erector-spinae"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "core",
    "muscleGroups": ["core", "lats", "serratus-anterior"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "hamstrings",
    "muscleGroups": ["hamstrings", "glutes", "erector-spinae", "quadriceps"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "full-body",
    "muscleGroups": ["quadriceps", "glutes", "hamstrings", "core", "erector-spinae", "shoulders"],
    "equipmentNeeded": ["kettlebell"],
    "imageUrls": [],
    "videoUrl": "",
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "quadriceps",
    "muscleGroups": ["quadriceps", "glutes", "shoulders", "core", "upper-back", "hamstrings"],
    "equipmentNeeded": ["kettlebell"],
    "imageUrls": [],
    "videoUrl": "",
  ...
  },
  {
    ...
    "category": "other",
    "primaryMuscleGroup": "shoulders",
    "muscleGroups": ["shoulders", "core", "forearms", "lats", "upper-back"],
  ...
  },
  {
    ...
    "category": "other",
    "primaryMuscleGroup": "quadriceps",
    "muscleGroups": ["quadriceps", "glutes", "upper-back", "core", "biceps", "forearms"],
    "equipmentNeeded": ["sandbag"],
    "imageUrls": []
  },
  {
  ...
  },
  {
    ...
    "category": "bodyweight-calisthenics",
    "primaryMuscleGroup": "core",
    "muscleGroups": ["rectus-abdominis", "hip-flexors", "triceps", "shoulders"],
    "equipmentNeeded": ["parallettes"],
    "imageUrls": []
  },
  {
  ...
  },
  {
    ...
    "category": "bodyweight-calisthenics",
    "primaryMuscleGroup": "lats",
    "muscleGroups": ["lats", "rhomboids", "biceps", "posterior-deltoid", "core"],
    "equipmentNeeded": ["gymnastic-rings"],
    "imageUrls": []
  },
  {
  ...
  },
  {
    ...
    "category": "other",
    "primaryMuscleGroup": "obliques",
    "muscleGroups": ["obliques", "glutes", "lower-back", "shoulders"],
    "equipmentNeeded": ["vipr"],
    "imageUrls": []
  },
  {
  ...
  },
  {
    ...
    "category": "other",
    "primaryMuscleGroup": "core",
    "muscleGroups": ["core", "anterior-deltoid", "chest", "triceps"],
    "equipmentNeeded": ["steel-mace", "macebell"],
    "imageUrls": []
  },
  {
  ...
  },
  {
    ...
    "category": "other",
    "primaryMuscleGroup": "shoulders",
    "muscleGroups": ["shoulders", "upper-back", "wrists"],
    "equipmentNeeded": ["indian-club"],
    "imageUrls": []
  },
  {
    ...
    "category": "other",
    "primaryMuscleGroup": "quadriceps",
    "muscleGroups": ["quadriceps", "glutes", "core", "upper-back", "erector-spinae", "biceps"],
    "equipmentNeeded": ["sandbag"],
    "imageUrls": []
  },
  {
    ...
    "category": "other",
    "primaryMuscleGroup": "full-body",
    "muscleGroups": ["core", "upper-back", "glutes", "legs", "forearms"],
    "equipmentNeeded": ["sandbag"],
    "imageUrls": []
  },
  {
  ...
  },
  {
    ...
    "category": "bodyweight-calisthenics",
    "primaryMuscleGroup": "shoulders",
    "muscleGroups": ["anterior-deltoid", "core", "biceps", "triceps"],
    "equipmentNeeded": ["parallettes"],
    "imageUrls": []
  },
  {
  ...
  },
  {
    ...
    "category": "bodyweight-calisthenics",
    "primaryMuscleGroup": "lats",
    "muscleGroups": ["lats", "biceps", "upper-back", "shoulders"],
    "equipmentNeeded": ["gymnastic-rings"],
    "imageUrls": []
  },
  {
  ...
  },
  {
    ...
    "muscleGroups": ["hamstrings", "quadriceps", "hip-flexors"],
    "equipmentNeeded": [],
  ...
  },
  {
    ...
    "category": "stretching",
    "primaryMuscleGroup": "glutes",
    "muscleGroups": ["glutes", "piriformis", "hip-flexors"],
    "equipmentNeeded": [],
  ...
  },
  {
    ...
    "category": "rehabilitation-mobility",
    "primaryMuscleGroup": "core",
    "muscleGroups": ["core", "hip-flexors", "erector-spinae"],
    "equipmentNeeded": [],
