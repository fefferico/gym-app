...
import type { MuscleValue } from './muscles-data';
...
export const EXERCISES_DATA: Exercise[] = [
  ...
  },
  {
    ...
    description: 'A compound upperBody exercise that targets the chestUpper, shoulders, and triceps using a barbell on an incline bench.',
    category: 'barbells',
  ...
  },
  {
    ...
    description: 'A compound upperBody exercise that targets the chestUpper, shoulders, and triceps using dumbbells on an incline bench, allowing for a greater range of motion.',
    category: "dumbbells",
    muscleGroups: ["chestUpper", "shoulders", "triceps"],
    primaryMuscleGroup: "chest",
  ...
  },
  {
    ...
    description: 'A compound overhead press exercise that builds shoulder strength and size. It is performed standing, engaging the core for stability, and pressing a barbell from the chestUpper to an overhead position with arms fully extended.',
    category: 'strength',
  ...
  },
  {
    ...
    "description": "A fundamental lowerBody exercise engaging quads, glutes, and hamstrings without external weight.",
    "category": "bodyweight-calisthenics",
  ...
  },
  {
    ...
    "description": "A fundamental compound exercise for upperBody strength, primarily targeting the chest, shoulders, and triceps.",
    "category": "barbells",
    "primaryMuscleGroup": "chest",
  ...
  },
  {
    ...
    "category": "barbells",
    "primaryMuscleGroup": "lats",
    "muscleGroups": ["lats", "rhomboids", "trapsMiddle","trapsLower", "biceps", "forearms", "lowerBack"],
  ...
  },
  {
    ...
    "category": "barbells",
    "primaryMuscleGroup": "hamstrings",
    "muscleGroups": ["hamstrings", "glutes", "lowerBack", "erectorSpinae"],
    "equipmentNeeded": ["barbell"],
  ...
  },
  {
    "id": "dumbbell-lunge",
    "name": "Dumbbell Lunge",
    "description": "Lunges performed while holding dumbbells, adding resistance to the lowerBody.",
    "category": "dumbbells",
    "primaryMuscleGroup": "quadriceps",
    "muscleGroups": ["quadriceps", "glutes", "hamstrings", "calves"],
    "equipmentNeeded": ["dumbbell"],
  ...
  },
  {
    ...
    "description": "A dynamic, explosive exercise targeting the posteriorChain (glutes, hamstrings, back) and improving power.",
  ...
  },
  {
    ...
    "description": "A two-part compound movement that targets the entire posteriorChain. One rep consists of performing a full kettlebell deadlift, hinging back down from the standing position, and then performing a bent-over row.",
    "category": "kettlebells",
  ...
  },
  {
    ...
    "description": "A foundational strength exercise using one or two kettlebells to target the posteriorChain, focusing on a hip hinge movement. Can be done with Kettlebell between feet or outside (suitcase style).",
    "category": "kettlebells",
    "primaryMuscleGroup": "hamstrings",
  ...
  },
  {
    ...
    "muscleGroups": ["core", "hipFlexors", "lowerBack"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "shoulders",
    "muscleGroups": ["shoulders", "glutes", "hamstrings", "upperBack", "biceps", "core"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "description": "A compound lowerBody exercise performed on a machine, pushing a weighted platform away with the legs.",
    "category": "machines",
    "primaryMuscleGroup": "quadriceps",
    "muscleGroups": ["quadriceps", "glutes", "hamstrings", "calves"],
  ...
  },
  {
    ...
    "equipmentNeeded": ["cable-machine", "straight-bar-attachment-cables"],
  ...
  },
  {
    ...
    "description": "A core rotational exercise engaging the obliques and transverseAbdominis.",
    "category": "cables",
    "primaryMuscleGroup": "obliques",
  ...
  },
  {
    ...
    "primaryMuscleGroup": "triceps",
    "muscleGroups": ["triceps"],
    "equipmentNeeded": ["resistance-band-loop", "anchor-point"],
  ...
  },
  {
    ...
    "equipmentNeeded": ["dumbbell", "kettlebell", "farmers-walk-handles"],
    "imageUrls": ["assets/images/exercises/farmers-walk_1.jpg", "assets/images/exercises/farmers-walk_2.jpg"]
  },
  {
    "id": "box-jump",
    "name": "Box Jump",
    "description": "A plyometric exercise that involves jumping onto an elevated platform, developing explosive power in the lowerBody.",
    "category": "bodyweight-calisthenics",
    "primaryMuscleGroup": "quadriceps",
    "muscleGroups": ["quadriceps", "glutes", "hamstrings", "calves"],
  ...
  },
  {
    ...
    "description": "An exercise targeting the posteriorChain (hamstrings, glutes, lower back) by hinging at the hips with a barbell on the upper back.",
    "category": "barbells",
    "primaryMuscleGroup": "hamstrings",
    "muscleGroups": ["hamstrings", "glutes", "lowerBack"],
    "equipmentNeeded": ["barbell", "rack"],
  ...
  },
  {
    ...
    "description": "Targets the chestUpper, shoulders, and triceps by pressing dumbbells on an incline bench.",
    "category": "dumbbells",
    "primaryMuscleGroup": "chestUpper",
    "muscleGroups": ["chestUpper", "anteriorDeltoid", "triceps"],
    "equipmentNeeded": ["dumbbell", "incline-bench"],
  ...
  },
  {
    ...
    "equipmentNeeded": ["elliptical-trainer"],
  ...
  },
  {
    "id": "battle-ropes",
    "name": "battle-ropes",
    "description": "A high-intensity, low-impact exercise that works the upperBody, core, and provides a cardiovascular challenge.",
    "category": "other",
    "primaryMuscleGroup": "fullBody",
  ...
  },
  {
    ...
    "description": "A lowerBody exercise combining lunges with overhead dumbbell hold to challenge stability and core engagement.",
    "category": "dumbbells",
    "primaryMuscleGroup": "quadriceps",
  ...
  },
  {
    "id": "jump-squat",
    "name": "Jump Squat",
    "description": "A plyometric squat that develops explosive power in the lowerBody.",
    "category": "bodyweight-calisthenics",
    "primaryMuscleGroup": "quadriceps",
    "muscleGroups": ["quadriceps", "glutes", "hamstrings", "calves"],
    "equipmentNeeded": [],
  ...
  },
  {
    ...
    "description": "A dynamic core and upperBody exercise that transitions between plank and push-up positions.",
    "category": "bodyweight-calisthenics",
    "primaryMuscleGroup": "core",
  ...
  },
  {
    "id": "pike-push-up",
    "name": "Pike Push-up",
    "description": "Targets the shoulders and chestUpper with a push-up position that emphasizes overhead pressing motion.",
    "category": "bodyweight-calisthenics",
    "primaryMuscleGroup": "shoulders",
  ...
  },
  {
    ...
    "description": "An increased difficulty push-up variation that targets the chestUpper and shoulders by elevating the feet.",
    "category": "bodyweight-calisthenics",
    "primaryMuscleGroup": "chest",
    "muscleGroups": ["chestUpper", "anteriorDeltoid", "triceps"],
    "equipmentNeeded": [],
  ...
  },
  {
    "id": "wall-sit",
    "name": "Wall Sit",
    "description": "Isometric lowerBody exercise that targets the quadriceps and improves endurance by holding a seated position against a wall.",
    "category": "bodyweight-calisthenics",
    "primaryMuscleGroup": "quadriceps",
  ...
  },
  {
    ...
    "description": "Lying prone, lift arms, chest, and legs off the ground to strengthen lower back and posteriorChain.",
    "category": "bodyweight-calisthenics",
    "primaryMuscleGroup": "lowerBack",
    "muscleGroups": ["lowerBack", "glutes", "hamstrings"],
    "equipmentNeeded": [],
  ...
  },
  {
    ...
    "description": "An explosive movement that lifts the kettlebell overhead in one fluid motion, engaging the entire posteriorChain.",
    "category": "kettlebells",
    "primaryMuscleGroup": "fullBody",
    "muscleGroups": ["hipFlexors", "glutes", "back", "shoulders", "arms"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    description: "Lift two kettlebells from the ground to a rack position, emphasizing posteriorChain strength.",
    category: "kettlebells",
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "hamstrings",
    "muscleGroups": ["hamstrings", "glutes", "core", "lowerBack", "hips"],
    "equipmentNeeded": ["kettlebell"],
  ...
  // Double kettlebell exercises
  {
    ...
    description: "Lift two kettlebells from the ground to rack position in one explosive movement, engaging full posteriorChain.",
    category: "kettlebells",
    primaryMuscleGroup: "fullBody",
    muscleGroups: ["hipFlexors", "back", "shoulders", "arms"],
    equipmentNeeded: ["kettlebell"],
  ...
  },
  {
    ...
    "description": "The standard two-handed kettlebell swing, a powerful hip-hinge movement for the posteriorChain.",
    "category": "kettlebells",
    "primaryMuscleGroup": "glutes",
  ...
  },
  {
    ...
    "description": "An isolation exercise for the chestUpper using dumbbells on an incline bench, focusing on the pectoral muscles.",
    "category": "dumbbells",
    "primaryMuscleGroup": "chestUpper",
    "muscleGroups": ["chestUpper", "anteriorDeltoid"],
    "equipmentNeeded": ["dumbbell", "incline-bench"],
  ...
  },
  {
    ...
    "description": "A machine-based compound exercise that targets the chestUpper, shoulders, and triceps with a guided, inclined pressing motion.",
    "category": "machines",
    "primaryMuscleGroup": "chestUpper",
    "muscleGroups": ["chestUpper", "anteriorDeltoid", "triceps"],
  ...
  },
  {
    ...
    "description": "A compound, high-intensity movement combining a sumo deadlift with an upright row. It develops power through the posteriorChain, upper back, and shoulders.",
    "category": "kettlebells",
    "primaryMuscleGroup": "fullBody",
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "lats",
    "muscleGroups": ["lats", "rhomboids", "traps", "biceps", "lowerBack"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "description": "A unique exercise that targets the lats and serratusAnterior while also challenging core stability. The kettlebell is held by the horns and lowered behind the head.",
    "category": "kettlebells",
    "primaryMuscleGroup": "lats",
  ...
  },
  {
    ...
    "description": "An explosive clean performed from a deep squatting stance with the kettlebell between the feet. This develops power from a compressed position and targets the entire posteriorChain.",
    "category": "kettlebells",
    "primaryMuscleGroup": "hamstrings",
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "glutes",
    "muscleGroups": ["glutes", "hamstrings", "core", "upperBack"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "description": "A deadlift performed with a kettlebell in each hand at your sides, like carrying two suitcases. This variation heavily loads the posteriorChain while intensely challenging grip and traps.",
    "category": "kettlebells",
    "primaryMuscleGroup": "hamstrings",
  ...
  },
  {
    ...
    "description": "A loaded stretch and spinal articulation drill. It involves slowly rolling the spine down, vertebra by vertebra, to stretch the entire posteriorChain.",
    "category": "kettlebells",
    "primaryMuscleGroup": "hamstrings",
    "muscleGroups": ["hamstrings", "erectorSpinae", "lowerBack", "glutes"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "core",
    "muscleGroups": ["core", "shoulders", "upperBack"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "category": "kettlebells",
    "primaryMuscleGroup": "shoulders",
    "muscleGroups": ["shoulders", "triceps", "core", "upperBack"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "description": "A variation of the goblet squat that adds a bicep curl at the bottom of the squat, increasing time under tension for the legs and adding upperBody work.",
    "category": "kettlebells",
    "primaryMuscleGroup": "quadriceps",
  ...
  },
  {
    ...
    "description": "A fundamental lowerBody exercise where you step backward into a lunge while holding a kettlebell in the goblet position, alternating legs with each repetition.",
    "category": "kettlebells",
    "primaryMuscleGroup": "quadriceps",
    "muscleGroups": ["quadriceps", "glutes", "hamstrings", "core"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "description": "A complex that combines a hip-hinge (Good Morning) with a squat pattern. It's excellent for warming up the entire lowerBody and reinforcing correct movement mechanics.",
    "category": "kettlebells",
    "primaryMuscleGroup": "hamstrings",
  ...
  },
  {
    ...
    "description": "A compound movement combining a bent-over row immediately followed by a deadlift, targeting the entire posteriorChain in one fluid motion.",
    "category": "kettlebells",
    "primaryMuscleGroup": "fullBody",
  ...
  },
  {
    ...
    "description": "A compound movement combining a bent-over row immediately followed by a deadlift using dumbbells, targeting the entire posteriorChain.",
    "category": "dumbbells",
    "primaryMuscleGroup": "fullBody",
    "muscleGroups": ["hamstrings", "glutes", "lowerBack", "lats", "rhomboids", "biceps"],
    "equipmentNeeded": ["dumbbell"],
  ...
  },
  {
    ...
    "category": "other",
    "primaryMuscleGroup": "shoulders",
    "muscleGroups": ["shoulders", "core", "forearms", "lats", "upperBack"],
  ...
  },
  {
    ...
    "category": "other",
    "primaryMuscleGroup": "fullBody",
    "muscleGroups": ["posteriorChain", "glutes", "lowerBack", "upperBack", "core"],
    "equipmentNeeded": ["sandbag"],
    "imageUrls": []
  },
  {
  ...
  },
  {
    ...
    "description": "A full-body loaded movement that mimics lifting an object from the ground to an overhead position, integrating the lowerBody, core, and upperBody.",
    "category": "other",
    "primaryMuscleGroup": "fullBody",
  ...
  },
  {
    ...
    "description": "A powerful, full-body rotational exercise that mimics the motion of digging with a shovel, heavily engaging the obliques, lats, and posteriorChain.",
    "category": "other",
    "primaryMuscleGroup": "obliques",
  ...
  },
  {
    ...
    "category": "other",
    "primaryMuscleGroup": "core",
    "muscleGroups": ["core", "anteriorDeltoid", "chest", "triceps"],
    "equipmentNeeded": ["steel-mace", "macebell"],
    "imageUrls": []
  },
  {
  ...
  },
  {
    ...
    "category": "other",
    "primaryMuscleGroup": "shoulders",
    "muscleGroups": ["shoulders", "upperBack", "wrists"],
    "equipmentNeeded": ["indian-club"],
    "imageUrls": []
  },
  {
    ...
    "category": "other",
    "primaryMuscleGroup": "quadriceps",
    "muscleGroups": ["quadriceps", "glutes", "core", "upperBack", "erectorSpinae", "biceps"],
    "equipmentNeeded": ["sandbag"],
    "imageUrls": []
  },
  {
  ...
  },
  {
    ...
    "description": "A dynamic movement combining a push-up or support hold with swinging the legs through the parallettes into an L-Sit position, building core and upperBody strength.",
    "category": "bodyweight-calisthenics",
    "primaryMuscleGroup": "core",
...

  {
    ...
    category: 'kettlebells',
    primaryMuscleGroup: 'back',
    muscleGroups: ['lats', "obliques", "hamstrings", "glutes", 'lowerBack'],
    equipmentNeeded: ['kettlebell'],
    imageUrls: [],
  },
  {
  ...
  },
  {
    ...
    category: 'kettlebells',
    primaryMuscleGroup: 'lats',
    muscleGroups: ['lats', 'traps', 'biceps', 'lowerBack'],
    equipmentNeeded: ['kettlebell'],
    imageUrls: [],
  ...
  },
  {
    ...
    "description": "A foundational strength exercise targeting the posteriorChain by lifting a single kettlebell with both hands. This movement emphasizes a proper hip hinge and is excellent for building hamstring, glute, and lower back strength.",
    "category": "kettlebells",
    "primaryMuscleGroup": "hamstrings",
    "muscleGroups": ["hamstrings", "glutes", "lowerBack", "core", "traps", "forearms"],
    "equipmentNeeded": ["kettlebell"],
  ...
  },
  {
    ...
    "category": "rehabilitation-mobility",
    "primaryMuscleGroup": "core",
    "muscleGroups": ["core", "glutes", "lowerBack"],
    "equipmentNeeded": [],
  ...
  },
  {
    ...
    "name": "Wall Push-up",
    "description": "An introductory push-up variation that reduces the load on the shoulders, wrists, and chest. It's an excellent way to begin rebuilding upperBody strength safely.",
    "category": "rehabilitation-mobility",
    "primaryMuscleGroup": "chest",
    "muscleGroups": ["chest", "anteriorDeltoid", "triceps"],
    "equipmentNeeded": [],
  ...
  },
  {
    ...
    "category": "rehabilitation-mobility",
    "primaryMuscleGroup": "lowerBack",
    "muscleGroups": ["lowerBack", "obliques"],
    "equipmentNeeded": [],
